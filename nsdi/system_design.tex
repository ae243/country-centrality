...
%    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=0.7\linewidth]{system_overview_updated}
...
\lstinputlisting[label={lst:pac}, language=JavaScript, frame=single, basicstyle=\footnotesize, caption={Example PAC file.}]{example_pac.pac}
