...
\annie{Possibly add a ``Naive Approaches'' subsection here to discuss 
why encryption, Tor, etc. don't solve our problem?}
...
\annie{add a subsection or subsubsection on the additional that open resolvers provide}
