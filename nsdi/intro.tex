...
The second part of our work (Section~\ref{avoid_results}) explores a
potential mechanism --- overlay network relays --- for avoiding certain countries, and it's
effectiveness.  We
find that this technique can be effective for clients in
certain countries, yet the effectiveness depends
on the country.  For example, Brazilian clients could completely avoid
...
The third part of our work (Section~\ref{system_design}) uses this
...
system uses a series of overlay network relays to automatically route a client's 
...
is effective for avoiding different countries, while having minimal performance overhead --- 
