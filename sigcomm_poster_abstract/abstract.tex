...
We found that there are ways to circumvent unfavorable countries, and these same ways can be used to keep local traffic local.  

Unfortunately, some of the more prominent surveillance states are also some of the {\textit least avoidable} countries.  Most countries are highly dependent on the US and not dependent on other countries -- the US is very central to interdomain routing.
