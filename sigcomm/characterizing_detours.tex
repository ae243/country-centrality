...
the Alexa Top 100 domains were enough to characterize routing detours by comparing 
...
(and ended in) each country are extremely similar between the two sets of paths.  Therefore, 
studying the Alexa Top 1000 domains does not provide more meaningful results than 
studying the Alexa Top 100 domains. To obtain the 3rd party
...
\textbf{IP geolocation vs.\ country mapping.}
