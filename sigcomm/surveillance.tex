...
\textbf{Brazil.} Brazil is actively trying to avoid having their
...
\textbf{Netherlands.}  First, the Netherlands is beginning to emerge
...
\textbf{Kenya.} Previous research on the interconnectivity of
...
\textbf{India.}  India has one of the highest number of Internet
users in Asia, second only to China, which has already been
well-studied~\cite{tsui2003panopticon, wang2010discourse}.  

\textbf{United States.}  We chose to study the United States because
