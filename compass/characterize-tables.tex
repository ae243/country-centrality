...
\caption{Fraction of paths terminating in a country.}%  The fraction in each cell represents the fraction of paths originating in the country at the top of the column and ending in the country indicated in the first cell of the same row.}
\label{tab:host}
\end{table}
...
\caption{Fraction of paths that a country transits.} %  The fraction in each cell represents the fraction of paths originating in the country at the top of the column that transit or end in the country indicated in the first cell of the same row.}
\label{tab:transit}
\end{table}
