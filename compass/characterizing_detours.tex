...
removed the long tail of countries that are the endpoint for less than 1\% of the measured paths).  Therefore, we used the Alexa Top 100 
...
\begin{figure}[t]
\centering
\includegraphics[width=.3\textwidth]{compare_cctld}
...
{\it Transit Traffic.} The United States and Great Britain are on more paths than any 
