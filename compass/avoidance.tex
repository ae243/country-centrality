\section{Feasibility of Region-Aware Networking}
\label{avoid_results}
...
For our measurements, we required root access to the servers that run as relays; for this reason, we used 
EC2 instances and VPS machines.  This requirement also restricted the number of relays we could set up 
to measure country avoidance.  Our results reflect this number of relays and their respective 
locations, but more relays in more diverse locations will provide for more country avoidability.
