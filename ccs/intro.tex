...
Although end-to-end encryption stymie surveillance by
...
Determining where a client's traffic traverses is challenging, for
...
limits the rate at which one can perform measurments.  As a result, we
...
with this inaccuracy by making conservative estimates on the extent of
...
United States.  About half of Kenyan paths to the top domains traverses
