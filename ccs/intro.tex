...
\annie{we need to change parts of this - get rid of systems paragraphs and add measurement/contribution paragraph}
...
\annie{this paragraph will change based on the rest of the paper.} This paper is organized as follows.  In the next section, we describe
