...
France             &.001    &.022      &.009      &.023       &.0013 \\
Germany            &.002    &.013      &.014      &.028       &.0013  \\
Great Britain      &.00006  &.019     &.021     &.032       &.0024 \\
Ireland            &.016    &.064      &.027       &.108       &.0012   \\
...
\textit{Country}    & \textit{Brazil}  & \textit{Netherlands}   & \textit{India} & \textit{Kenya} & \textit{United States}\\ \toprule
Brazil              &1.00       & -   & -     & -     & -\\ \midrule
Canada                &.013       &.007     &.016       &.008      &.081 \\
United States        &\cellcolor[HTML]{F7BE81}.844        &\cellcolor[HTML]{F7BE81}.583     &\cellcolor[HTML]{F7BE81}.715      &\cellcolor[HTML]{F7BE81}.616       &\cellcolor[HTML]{F7BE81}1.0 \\ \midrule
...
Netherlands                 &.019        &1.0      &.121      &\cellcolor[HTML]{F7BE81}.253      &.031 \\\hline
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{World-DNS}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{domain_hist_US1}
