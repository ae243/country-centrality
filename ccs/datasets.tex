...
All of the countries studied (except for the United States) host content for a small percentage of their own traffic.
\end{finding}
...
\begin{finding}[Country Code Top-Level Domains]
A small fraction of country code top-level domains are hosted within the respective country.
\end{finding}
...
The United States transits the largest portion of traffic in comparison to any other (foreign) country.
\end{finding}
...
%Of the five countries studied, the Netherlands has the lowest percentage of traffic that transits the United States at 58\%.  
...
%The most common countries traffic trombones to are the United States and Great Britain.
