...
measurement results only provide a lowerbound on the number of countries
...
Accurate IP geolocation is a challenging problem. We use MaxMind's
...
finer granularities~\cite{huffaker2011geocompare}.  In light of these
